var stylerModule = function() {
	...
	/***************************************************************************
	 * @opt_options: a json object check default_point_options for example of
	 *               opt_options
	 */
	this.createPoint = function(opt_options) {
		return new ol.style.Circle({
			...
			fill : new ol.style.Fill({
				color : opt_options.fillColor
						|| this.default_point_options.fillColor
			}),
			stroke : new ol.style.Stroke({
				color : opt_options.strokeColor
						|| this.default_point_options.strokeColor,
				width : opt_options.strokeWidth
						|| this.default_point_options.strokeWidth,
			})
		});
	}

	/***************************************************************************
	 * @opt_options: a json object check default_image_options for example of
	 *               opt_options
	 */
	...
	/***************************************************************************
	 * @opt_options: a json object check default_text_options for example of
	 *               opt_options
	 */
	...
	this.createText = function(opt_options) {
		return new ol.style.Text({
			...
			stroke : new ol.style.Stroke({
				color : opt_options.strokeColor
						|| default_text_options.strokeColor,
				width : opt_options.strokeWidth
	 ...
	 * 
	 * Name Type geometry undefined | string | ol.geom.Geometry |
	 * ol.StyleGeometryFunction fill ol.style.Fill | undefined image
	 * ol.style.Image | undefined stroke ol.style.Stroke | undefined text
	 * ol.style.Text | undefined zIndex number | undefined reference:
