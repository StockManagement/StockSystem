...
CREATE TABLE `weight_unit` (
  `idweight_unit` int(11) NOT NULL AUTO_INCREMENT,
  `weight_unit_name` varchar(45) COLLATE utf8_bin NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`idweight_unit`)
...
-- Dump completed on 2016-08-23 11:44:00
